...
class CasesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create case" do
    assert_difference('Case.count') do
      post cases_url, params: { case: { description: @case.description, link: @case.link, name: @case.name, photo: @case.photo } }
    end
  ...
  test "should update case" do
    patch case_url(@case), params: { case: { description: @case.description, link: @case.link, name: @case.name, photo: @case.photo } }
